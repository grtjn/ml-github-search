# Contributing to ml-github-search

ml-github-search welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-github-search, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic.
...
* **ml-github-search Version** - is it a named version or from our master branch
...
#### Fork ml-github-search

Fork the project [on GitHub](https://github.com/grtjn/ml-github-search/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-github-search.git
$ cd ml-github-search
$ git remote add upstream git://github.com/grtjn/ml-github-search.git
```
...
Go to https://github.com/username/ml-github-search and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-github-search/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-github-search/issues
